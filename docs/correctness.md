...
3. **The public API** is covered in squidpy itself by
   [`test_align_stalign.py`](https://github.com/selmanozleyen/squidpy/blob/e9a94c4/tests/experimental/tl/test_align_stalign.py)
   and
   [`test_align_landmarks.py`](https://github.com/selmanozleyen/squidpy/blob/e9a94c4/tests/experimental/tl/test_align_landmarks.py)
...
Run against upstream STalign `b2068ed` and squidpy fork `e9a94c4` — the same pinned pair behind
