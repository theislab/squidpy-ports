...
pinned squidpy JAX port (`selmanozleyen/squidpy@6d1926a`), the pinned upstream STalign
...
| squidpy JAX port | `selmanozleyen/squidpy@6d1926a` (`feat/experimental-fit-core`) | installed from git at build |
