...
pinned squidpy JAX port (`selmanozleyen/squidpy@7ff381e`), the pinned upstream STalign
...
| squidpy JAX port | `selmanozleyen/squidpy@7ff381e` (`feat/experimental-fit-core`) | installed from git at build |
