...
pinned squidpy JAX port (`selmanozleyen/squidpy@e9a94c4`), the pinned upstream STalign
...
| squidpy JAX port | `selmanozleyen/squidpy@e9a94c4` (`feat/experimental-fit-core`) | installed from git at build |
